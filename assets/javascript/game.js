...
// for(i = 0; i< 4; i++){
//     var thisGemNumber = Math.floor(Math.random()*12)+1;
//     gemNumberArr.push(thisGemNumber);
// }
//stats at the beginning of game
...
// $(".gem").click(function(){
//     userScore = userScore + thisGemNumber;
//     $("#totalScore").text(userScore);
//     if(userScore===randomNumber){
//         gameWin();
//     }
...
var reset = function(){
    ...
    thisGemNumber = Math.floor(Math.random()*12)+1;
    $("#gameScore").text ("randomNumber");
    $("#totalScore").text ("userScore");
